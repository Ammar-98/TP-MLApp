...
const options = {
  ...
  scales: {
    x: {
      ...
      title: {
        display: true,
        text: "Failed Screening ML Reasons",
        color: "#163143",
        font: {
          size: 12,
        },
...
const FailedScreeningReasons = () => {
  const { data, isLoading, isRefetching }: any = useQuery({
    queryKey: ["FailedScreeningReasons"],
    queryFn: () => getData(),
  });
...
export default FailedScreeningReasons;
